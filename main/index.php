...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<form name="clock">
			<font color="black">Time: <br></font>&nbsp;<input style="width:150px;" type="submit" class="trans" name="face" value="">
			</form>
			  </div>
			</li>
				</ul>                               
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Dashboard
			          ...
			          <img src="img/logo.png" width="100px" height="81px" style="margin:4px 100px 28px 310px;"><br>
			<font style=" font:bold 44px 'Aleo'; padding-left:140px;text-shadow:1px 1px 25px #000; color:#fff;"></center><span style="color:#383a3a;">Super Fine  Enterprises</span></center></font>
<div id="mainmain">
