...
<select name="name" style="width:265px; height:30px; margin-left:-5px;" >
	...
	?>
		<option><?php echo $rows['cname']; ?></option>
	<?php
	}
	?>
</select><br>
<span>Brand Name : </span>
<input type="text" style="width:265px; height:30px;"  name="code" value="<?php echo $row['product_code']; ?>" /><br>
<span>Model Name : </span><input type="text" style="width:265px; height:30px;"  name="gen" value="<?php echo $row['gen_name']; ?>" /><br>
...
<span>Colombo Discount : </span><input type="text" min="0" max="100" style="width:265px; height:30px;" id="txt32" name="cdisc" value="<?php echo $row['cdisc']; ?>"  onkeyup="sum();" Required/><br>
<span>Colombo sale Price : </span><input type="text" style="width:265px; height:30px;" id="txt2" name="o_price" value="<?php echo $row['o_price']; ?>" onkeyup="sum();" Required/><br>
<span>Bought Price : </span><input type="text" style="width:265px; height:30px;" id="txt55" name="b_price" value="<?php echo $row['bprice']; ?>" onkeyup="sum();" Required/><br>
<span>Selling Price : </span><input type="text" style="width:265px; height:30px;" id="txt19" name="price" value="<?php echo $row['price']; ?>" onkeyup="sum();" Required/><br>
