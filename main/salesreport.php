...
<span style="font-size: 1em;font-weight: bold;margin-left: 100px;margin-bottom: 5px;">Total Sales: Rs.<?php
				...
				include('../connect.php');
				$results = $db->prepare("SELECT sum(amount) FROM sales WHERE transaction_id");
				$results->execute();
				...
				?></span><br>
<span style="font-size: 1em;font-weight: bold;margin-left: 48px;margin-bottom: 25px;">Total Sales Profit: Rs.<?php 
				$resultia = $db->prepare("SELECT sum(profit) FROM sales WHERE transaction_id");
				$resultia->execute();
				...
				?></span><br>
<input type="text" name="filter" style="height:35px; margin-top: -1px;margin-left: 12px;" value="" id="filter" placeholder="Search Inovice Number..." autocomplete="off" />
<br><br>
<form action="salesreport.php" method="get">
<center><strong>From : <input type="text" style="width: 223px; padding:14px;" name="d1" hidden="hidden" class="tcal" value="" /> To: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
